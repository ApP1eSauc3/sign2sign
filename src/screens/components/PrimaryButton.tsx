...
// Disabled state is token-only — never opacity (design-system guide §1.5/§6 guardrail).
...
export function PrimaryButton({
  ...
  if (loading) {
    // In-flight, not invalid — reads as active/busy, matches the design-system guide §3.1's
